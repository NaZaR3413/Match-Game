...
function appendNewCard(parentElement) {
	...
	const cardElement = createNewCard('div');
...
const shuffledClasses = _.shuffle(cardClasses);
  ...
  NOTE: Ignore the "requiree" syntax shown in the documentation as this is for non-browser environments. The '_' variable will already be available to you from loading the CDN. */
...
const newCardElement = appendNewCard(parentElement);
...
const flipsCounter = document.querySelector("#flip-count");
  const matchesCounter = document.querySelector("#match-count");
  flipsCounter.innerText = "0";
